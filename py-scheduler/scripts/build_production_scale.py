...
# Sized to ~45k inference pods total, in line with docs/scaling_requirements.md
# ("~50k inference pods in the system: mix of running and pending").
INFERENCE_DEPLOYMENTS: list[tuple[str, str, str, str, int, int]] = [
    ("serve-search-prod", "serve-search", "H100", "us-west-2", 8000, 25),
    ("serve-search-eu", "serve-search", "H200", "eu-west-1", 3000, 25),
    ("serve-recsys-prod", "serve-recsys", "H100", "us-west-2", 6500, 22),
    ("serve-recsys-asia", "serve-recsys", "H100", "ap-east-1", 2400, 22),
    ("serve-ads-prod", "serve-ads", "H100", "us-east-2", 3200, 28),
    ("serve-ads-eu", "serve-ads", "H200", "eu-west-1", 900, 28),
    ("serve-chat-prod", "serve-chat", "H100", "us-west-2", 3500, 30),
    ("serve-chat-asia", "serve-chat", "H200", "ap-northeast-1", 2400, 30),
    ("serve-embeddings", "serve-embeddings", "H100", "us-central-1", 2200, 18),
    ("serve-embeddings-eu", "serve-embeddings", "H200", "eu-west-1", 900, 18),
    ("serve-translate", "serve-translate", "H200", "eu-west-1", 1000, 16),
    ("serve-translate-de", "serve-translate", "A100", "eu-central-1", 900, 16),
    ("serve-async", "serve-async", "H100", "us-east-2", 1400, 14),
    ("serve-async-asia", "serve-async", "A100", "ap-south-1", 1500, 14),
    ("serve-realtime", "serve-realtime", "H100", "us-west-2", 1800, 32),
    ("batch-vision-eu", "batch-vision", "L40S", "eu-west-2", 1500, 12),
    ("batch-vision-ca", "batch-vision", "L40S", "ca-central-1", 1000, 12),
    ("batch-speech-me", "batch-speech", "L40S", "me-south-1", 900, 11),
    ("batch-summary-af", "batch-summary", "H100", "af-south-1", 700, 11),
    ("batch-eval-india", "batch-eval", "A100", "ap-south-1", 1200, 10),
    ("batch-eval-sa", "batch-eval", "A100", "sa-east-1", 900, 10),
    ("mlops-platform", "mlops-platform", "H100", "us-west-2", 400, 35),
    ("mlops-platform-east", "mlops-platform", "H200", "us-east-1", 250, 35),
    ("oncall-debug", "oncall-debug", "H200", "us-east-1", 120, 40),
]
